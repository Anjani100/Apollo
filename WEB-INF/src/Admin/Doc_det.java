...
public class Doc_det extends HttpServlet {
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
				...
				String n = request.getParameter("Name-D");
				ResultSet rs;
				...
				try{
					...
					Statement stm = con.createStatement();
						...
						if(rs.next()){
							...
							hs.setAttribute("doctor", n);
							RequestDispatcher rd = request.getRequestDispatcher("Admin_doc.jsp");
