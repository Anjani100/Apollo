			...
			throws ServletException, IOException {
				...
				try{
					...
					Statement stm = con.createStatement();
						...
						int i = stm.executeUpdate("update doctor set Pass_word = '"+np+"' where (Name = '"+n+"' or Email = '"+n+"') and Pass_word = '"+p+"'");
						if(i == 1){
							...
							RequestDispatcher rd = request.getRequestDispatcher("UpdateD_wrong_password.jsp");
							rd.forward(request, response);
						}
				}
				catch(Exception e1) {
