				...
				try{
					...
					Statement stm = con.createStatement();
						...
						if(rs.next()){
							...
							RequestDispatcher rd = request.getRequestDispatcher("Patient_details.jsp");
							rd.forward(request, response);
						}
						else {
							System.out.println("No Data found for " + n);
							RequestDispatcher rd = request.getRequestDispatcher("Home_Page_Doc_wrong_details.jsp");
							rd.forward(request, response);
						}
				}
				catch(Exception e1) {
