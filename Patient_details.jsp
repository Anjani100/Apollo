...
<body>
	...
	<a id = "header2" href = "UpdateD.html">Update Details</a>
	<a id = "header3" href = "">Resources</a>
	<a id = "header4" href = "Home_Page_Doc.html">View Patient Details</a>
      ...
      <caption>
        ...
        <%
        	try{
    			...
    			String n = (String)hs.getAttribute("key2");
    			...
    			while(rs.next()) {
    				...
    				<%System.out.println(rs.getString(3));%><td><%= rs.getString(3) %></td>
    				<%System.out.println(rs.getString(4));%><td><%= rs.getString(4) %></td>
    				<%System.out.println(rs.getString(5));%><td><%= rs.getString(5) %></td>
    				<%System.out.println(rs.getInt(6));%><td><%= rs.getInt(6) %></td>
    				<%System.out.println(rs.getString(7));%><td><%= rs.getString(7) %></td>
    				<%System.out.println(rs.getString(8));%><td><%= rs.getString(8) %></td>
    				<%System.out.println(rs.getString(9));%><td><%= rs.getString(9) %></td>
    				<%System.out.println(rs.getString(10));%><td><%= rs.getString(10) %></td>
    				<%System.out.println(rs.getString(11));%><td><%= rs.getString(11) %></td>
    				<%System.out.println(rs.getInt(12));%><td><%= rs.getInt(12) %></td></tr>
    			<% }
        	}
        	catch(Exception e){
