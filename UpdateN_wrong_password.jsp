...
<body>
	...
	<form action = "updateN"  method = "post">
		<p id = "name1">Username or Email-Id</p><input id = "input1" type = "text" name = "Name" required />
		<p id = "name2">Password</p><input id = "input2" type = "password" name = "Password" required />
		<p id = "name3">Enter your New Password</p><input id = "input3" type = "password" name = "NPassword" required />
		<p id = "name4">Confirm New Password</p><input id = "input4" type = "password" name = "CNPassword" required />
