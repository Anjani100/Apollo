      ...
      <caption>
        ...
        <%
        	try{
    			...
    			String s = (String)hs.getAttribute("key1");
    			rs = stm.executeQuery("Select * from doctor where Name = '"+s+"'");
    			while(rs.next()) {
    				...
    				<%System.out.println(rs.getInt(8));%><td><%= rs.getInt(8) %></td></tr>
    			<% }
        	}
        	catch(Exception e){
        ...
        %>
      <%--<tbody>
        <tr><td>src</td><td>Used to Specify the URL of the Image<td rowspan = "2">src="abc.png"</td></tr>
        <tr><td colspan = "2">alt: Used to specify replacement text for the image</td></tr>
      </tbody> --%>
      </table>
	</table>
	<p id = "a1">
